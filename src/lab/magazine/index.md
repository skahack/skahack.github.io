...
<!--
いまのWebはどうなっていて、雑誌の体験を持ってくるとどうなるのか的な話

雑誌の体験はどこを目指すのか

企業のランディングページ、通称ペライチのようなところ
楽天のショップのようなところ

ここでは、文章が主体のコンテンツをどう読みやすくするかを目指す
ランディングページは区切りをつけて読ませることが多い印象
-->
...
<!--
雑誌は一度にたくさんの情報が視界に入るけど、画面でみると一部しか見えない的な話
-->
...
<!--
上からスクロールした時に、どうやってその文脈を下まで引き継いでいくか的な話
-->
...
画像の回り込み、大きめの見出しをテキストに回りこませる、など色々なパターン
ECサイトの例
また見出し単位で背景色を変えても効果があります。
-->
...
<!--
読み始めさせるのも、全部読んでもらうのも難しい。何か工夫はできないか的な話
-->
...
<!--
Mediumとか文字大きいけど意味あるの的な話
文字が大きいと文章中の位置が明確になって読みやすいが、全体のどこに居るかは分かりづらい
-->
...
<!--
文章のとなりに直接は関係ないコンテンツ（新着記事や広告など）を置くのは良くない
-->
...
<!--
Webで一貫したテーマでコンテンツを作る必要はあるのか的な話
-->
...
購入することは読むための強い動機になる的な話

## 終りがあること

雑誌に掲載されているコンテンツには限りがある的な話

## 細かいことは隠す

例えば「記事を購入するには」のような細かいこと（文字が小さくなりがちな情報）は
隠しておく。実際の行動につながる場面でポップアップなどで表示

## 文章量

同じ文章量でも雑誌のほうが文章量が多く見える的な話

## 編集者のいないWeb

編集者もいない、素人が書くコンテンツをいかに読みたくさせるか的な話

## コンテンツのつまみ食い

Webはコンテンツを読み飛ばしたあとで、読み返すのが難しい。
どうやって読み返してもらえるようにするか的な話

## タイトル

釣りタイトルを使わないで、どうやって読ませるか的な話

# 大画面をもっと活かす

解像度の高い画面だと寂しいことになりがちだけど、どうするといいか的な話

# Webはシンプル

シンプルなのは素晴らしい。でも飽きてきてる的な話

# Webは文字と写真だけじゃない

音声もビデオも使えるし、文字と写真にも動きが付けられる的な話
